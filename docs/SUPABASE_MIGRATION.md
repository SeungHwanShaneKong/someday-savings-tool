...
3. 타깃 Auth→URL Config: `https://wedsem.moderninsightspot.com/**` + `http://localhost:8082/**`.
...
3. Auth → URL Configuration → Site URL + Redirect URLs: `https://wedsem.moderninsightspot.com/**` (+ dev `http://localhost:8082/**`).
