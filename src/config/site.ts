...
// [CL-WEDSEM-REDIRECT-20260621] wedsem.moderninsightspot.com 은 GitHub Pages 가 자동 301 하지 않음
//   (repo당 커스텀도메인 1개 → apex 승격 후 wedsem 은 "no site" 404 였음). 별도 repo
//   `SeungHwanShaneKong/wedsem-redirect` 가 wedsem 도메인을 claim 해 apex 동일경로로 리다이렉트한다.
