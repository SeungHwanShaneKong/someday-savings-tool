...
export const BUDGET_CATEGORIES: Category[] = [
  {
    ...
    subCategories: [
      ...
      { id: 'main-dvd', name: '본식DVD', placeholder: '본식 DVD 촬영' },
      { id: 'ceremony-staff', name: '축가, 축의대, 사회비', placeholder: '축가, 축의대, 사회자 비용' },
      { id: 'helper-fee', name: '결혼식 헬퍼비', placeholder: '결혼식 도우미 비용' },
      { id: 'thank-you-gifts', name: '답례품 준비비', placeholder: '하객 답례품' },
      { id: 'extra-photos', name: '원판사진 추가비', placeholder: '추가 사진 비용' },
    ],
  },
  {
    id: 'sudeme-styling',
    ...
    subCategories: [
      ...
      { id: 'groom-family-makeup', name: '신랑 가족 메이크업', placeholder: '신랑 측 가족 메이크업' },
      { id: 'bride-family-makeup', name: '신부 가족 메이크업', placeholder: '신부 측 가족 메이크업' },
      ...
      { id: 'couple-hanbok', name: '신랑/신부 한복', placeholder: '신랑/신부 한복' },
    ],
  },
  {
    id: 'gifts-houseware',
    ...
    subCategories: [
      ...
      { id: 'bed-mattress', name: '침대 매트리스', placeholder: '침대 및 매트리스' },
  ...
  },
  {
    ...
    name: '사전 준비 및 홍보',
    icon: '📋',
    description: '사전 준비 및 홍보 비용을 입력해주세요',
  ...
  },
  {
    ...
    subCategories: [
      ...
      { id: 'accommodation-2', name: '숙소 (#2, OOO)', placeholder: '두 번째 숙소' },
    ],
  },
  {
    id: 'miscellaneous',
