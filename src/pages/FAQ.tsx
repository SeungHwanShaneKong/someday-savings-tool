...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      // [CL-COST-2026Q2-20260713-231500] 듀오 2026 보고서 기준으로 갱신
      '2026년 기준 평균 결혼 비용은 신혼집(주거)을 포함하면 약 3억 8,113만 원(듀오 2026 보고서)이며, 이 금액의 대부분(약 84%)은 신혼집 마련 비용입니다. 주거를 제외한 예식장·스드메·식대·혼수·예물·신혼여행 등 결혼식 관련 비용은 약 2,100만~8,100만 원 수준입니다. 지역·규모·취향에 따라 차이가 크며, 웨딩셈에서 항목별로 정확히 시뮬레이션해볼 수 있습니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      // [CL-COST-2026Q2-20260713-231500] 신혼여행 범위 상단 확장(듀오 2026 평균 763만 원 포함)
      '목적지에 따라 200만~900만 원까지 다양합니다. 동남아(발리, 다낭 등)는 200만~400만 원, 유럽·하와이 등은 700만 원 이상이 일반적입니다. 웨딩셈의 AI 허니문 큐레이션 기능을 활용하면 예산에 맞는 여행지를 추천받을 수 있습니다.',
  },
  {
