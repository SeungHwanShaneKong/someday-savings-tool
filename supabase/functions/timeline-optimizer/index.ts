// [AGENT-TEAM-9-20260307] [CL-CHECKLIST-9PERIOD-20260412-130000]
...
9단계 준비 로드맵 (각 기간의 핵심 테마):
- D-12~10m: 전체 방향 잡기 (예산·스타일·날짜·웨딩홀·하객수)
- D-10~8m: 큰 업체 라인업 확정 (스드메 계약·플래너·본식 영상/스냅)
- D-8~6m: 촬영 준비 + 외형 관리 (촬영 날짜·다이어트·피부관리·시술·신혼여행 리서치)
- D-6~5m: 웨딩 촬영 실행 + 신혼집 (드레스 셀렉·촬영 진행·부케·신혼집)
- D-5~4m: 중간 점검 + 신혼여행 확정 (항공·숙소·예물/예단 협의·청첩장 스타일)
- D-4~3m: 예물·예단 진행 + 청첩장 제작 (예물/예단·혼수·청첩장·본식 드레스·한복)
- D-3~2m: 하객 준비 (청첩장 발송·식순/사회자/축가 섭외·청첩장 모임)
- D-2~1m: 최종 피팅 & 신혼집 정리 (드레스/혼주 의상 피팅·리허설·입주·답례품 주문)
- D-1~0: 마무리 & 멘탈 관리 (식순 확정·좌석·컨디션 관리, 전날 절대 무리 금지)
...
- 각 월이 어느 단계에 해당하는지 위 9단계 로드맵을 참고하여 해당 테마에 부합하는 task를 우선 배치하세요.
