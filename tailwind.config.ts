  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "coffee-wiggle": {
          "0%, 91%": { transform: "rotate(0deg) scale(1)" },
          "92.5%": { transform: "rotate(-3deg) scale(1.05)" },
          "94%": { transform: "rotate(3deg) scale(1.05)" },
          "95.5%": { transform: "rotate(-2deg) scale(1.03)" },
          "97%": { transform: "rotate(2deg) scale(1.03)" },
          "98.5%, 100%": { transform: "rotate(0deg) scale(1)" },
        },
      },
      animation: {
