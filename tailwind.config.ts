  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "coffee-wiggle": {
          "0%, 97%": { transform: "rotate(0deg) scale(1)" },
          "97.5%": { transform: "rotate(-3deg) scale(1.05)" },
          "98%": { transform: "rotate(3deg) scale(1.05)" },
          "98.5%": { transform: "rotate(-2deg) scale(1.03)" },
          "99%": { transform: "rotate(2deg) scale(1.03)" },
          "99.5%, 100%": { transform: "rotate(0deg) scale(1)" },
        },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "coffee-wiggle": "coffee-wiggle 30s ease-in-out infinite",
      },
    },
  },
